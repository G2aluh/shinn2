...
export const Contact = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    // Ganti URL ini dengan URL Formspree Anda
    const formspreeUrl = "https://formspree.io/f/mldeavew";
    ...
    try {
      ...
      if (response.ok) {
        ...
        setStatus({ success: false, message: 'Terjadi kesalahan, silakan coba lagi dan cek apakah email anda benar.' });
      }
    } catch (error) {
